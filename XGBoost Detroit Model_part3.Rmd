...
detroit_pedestrians <- read_csv("detroit-pedestrians.csv", col_types = cols(.default = col_factor()))
...
xgb.ggplot.importance(importance_matrix = feature.importance.detroit, top_n = 20) +
  labs(title = "Top Features For City of Detroit Pedestrian Traffic Accidents") +
  theme_minimal()


ggsave('detroit-feature-importance.png')
